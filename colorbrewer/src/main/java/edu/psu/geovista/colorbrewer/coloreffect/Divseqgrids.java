...
public class Divseqgrids extends SchemeObject{
  ...
  public Divseqgrids(int vclass, int hclass, int maxlightness, int minlightness, int alpha, int range, int dx, int dy, int startinghue) {
    ...
    //double height = Math.tan(Math.toRadians(alpha))*gridwidth;
    //double x = gridwidth - (minlightness/Math.tan(Math.toRadians(alpha)));
