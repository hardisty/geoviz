 ...
 * @version %I%, %G%
 */
public final class BivariatePalette implements Palette2D {
	// **********************************************************************
	...
	public static final BivariatePalette QUA_SEQ_BELL_CURVE1 = new BivariatePalette(
	...
	public static final BivariatePalette QUA_SEQ_BELL_CURVE2 = new BivariatePalette(
	...
	// vertex=141, divider=7500, lightness range=26~95,
	// startinghue=25, deviation a-b=0, deviationy=0
	public static final BivariatePalette SEQ_QUA_BELL_CURVE1 = new BivariatePalette(
	...
	// vertex=164, divider=4913, lightness range=23~87,
	// startinghue=292, deviation a-b=0, deviationy=0
	public static final BivariatePalette SEQ_QUA_BELL_CURVE2 = new BivariatePalette(
	...
	public static final BivariatePalette QUA_SEQ_CONE1 = new BivariatePalette(
	...
	// cone height=130, cone radius=120, lightness range=35~97,
	// startinghue=10, deviation a-b=0, deviationy=0
	public static final BivariatePalette SEQ_QUA_CONE1 = new BivariatePalette(
			"quaseqcone1", QUALITATIVE_SEQUENTIAL, new int[][] {
	...
	public static final BivariatePalette DIV_DIV_BELL_CURVE1 = new BivariatePalette(
	...
	public static final BivariatePalette DIV_DIV_BELL_CURVE2 = new BivariatePalette(
	...
	public static final BivariatePalette DIV_SEQ_ELLIPSE_DOWN1 = new BivariatePalette(
	...
	// top angle=90, shape index=80, lightness range=46~100,
	// startinghue=138, deviation a-b=0, deviationy=4
	public static final BivariatePalette SEQ_DIV_ELLIPSE_DOWN1 = new BivariatePalette(
	...
	public static final BivariatePalette DIV_SEQ_TRAPEZOID1 = new BivariatePalette(
	...
	// top angle=109, radius=75, lightness range=50~95,
	// startinghue=230, deviation a-b=0, deviationy=0
	public static final BivariatePalette SEQ_DIV_TRAPEZOID1 = new BivariatePalette(
	...
	public static final BivariatePalette DIV_SEQ_GRID1 = new BivariatePalette(
	...
	// top angle=150, saturation range=120, lightness range=35~100,
	// startinghue=0, deviation a-b=0, deviationy=0
	public static final BivariatePalette SEQ_DIV_GRID1 = new BivariatePalette(
	...
	public static final BivariatePalette SEQ_SEQ_GRAY_DIAMOND1 = new BivariatePalette(
	...
	public static final BivariatePalette SEQ_SEQ_GRAY_DIAMOND2 = new BivariatePalette(
	...
	public static final BivariatePalette SEQ_SEQ_NONGRAY_DIAMOND1 = new BivariatePalette(
