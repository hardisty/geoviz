/* -------------------------------------------------------------------
 ...
 Java source file for the class SonicRampPickerMain
 Copyright (c), 2000, GeoVISTA Center
 All Rights Reserved.
 Original Author: Frank Hardisty
 $Author: jmacgill $
 $Id: SonicRampPickerMain.java,v 1.2 2003/07/29 15:47:12 jmacgill Exp $
 $Date: 2003/07/29 15:47:12 $
...
/*
	public SonicRampPickerMain(String name) {
		super(name);
                setUp();
	}
	...
	protected void setUp() {
		vc = new SonicRampPicker();
	}
	public static Test suite() {
		//return new TestSuite(SonicRampPickerTest.class);
          return null;
	}*/
