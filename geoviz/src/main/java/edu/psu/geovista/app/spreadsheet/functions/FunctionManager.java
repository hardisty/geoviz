...
public class FunctionManager {
   ...
   /**
     ...
     * @param func the edu.psu.geovista.app.spreadsheet.functions.Function object
     * @see edu.psu.geovista.app.spreadsheet.functions.Function
     */
...
/*
	...
	register("MEAN", new edu.psu.geovista.app.spreadsheet.functions.FunctionAverage());
	register("AVERAGE", new edu.psu.geovista.app.spreadsheet.functions.FunctionAverage());
