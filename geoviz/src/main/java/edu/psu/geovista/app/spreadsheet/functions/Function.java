 ...
 *
 * Description:
 * Function classes used only by edu.psu.geovista.app.spreadsheet.formula.Formula to evaluate functions.
...
public abstract class Function {
	...
	return exp.size() == 1 &&
        ...
        //((edu.psu.geovista.app.spreadsheet.formula.Node)param.getExp().getFirst()).isType(edu.psu.geovista.app.spreadsheet.formula.Node.COLON);
    }
     ...
     * @param node the edu.psu.geovista.app.spreadsheet.formula unit
    ...
    protected float getSingleParameter( Node node)
        ...
        //	edu.psu.geovista.app.spreadsheet.formula.Node param = node.getNextParam();
...
} //edu.psu.geovista.app.spreadsheet.functions.Function Class
