...
//import edu.psu.geovista.app.spreadsheet.formula.FormulaEditor;
...
public class SSTable extends JTable {
    ...
    //edu.psu.geovista.app.spreadsheet.model.TableColumnSort tcs;
    public SSTable(SSTableModel tm) {
        super(tm);
        tm.setTable(this);
        funManager=new FunctionManager(this);

        //tcs=new edu.psu.geovista.app.spreadsheet.model.TableColumnSort(this);
    }
    /********************************************************************
     *                Event handler
     ********************************************************************/
...
/*for (int i=0;i<rows.length ;i++){
            ...
            sr.setType(edu.psu.geovista.app.spreadsheet.model.SortRange.ROWS );  */
            int col=this.showSortDialog() ;
            if (col<0) return;//cancel sort
...
/*for (int i=0;i<cols.length ;i++){
            ...
            sr.setType(edu.psu.geovista.app.spreadsheet.model.SortRange.COLUMNS ); */
            int col=this.showSortDialog() ;
            if (col<0) return;//cancel sort
            /*
...
/*//mrows[i]=Cell.transRowViewToTable(rows[i]);//
                    ...
                    //(which may be the sort edu.psu.geovista.app.spreadsheet.model instead of real edu.psu.geovista.app.spreadsheet.model)
...
/*
            ...
            sr.setType(edu.psu.geovista.app.spreadsheet.model.SortRange.RANGE );
    ...
    //auto update edu.psu.geovista.app.spreadsheet.formula value
...
//    }
    ...
    public int transColModelToView(int modelCol){
            ...
            return i;
            //return modelCol- edu.psu.geovista.app.spreadsheet.model.SSTableModel.BASE_COL +1 ;//jin
    }
    ...
    /**
        ...
        public int transColViewToModel(int  viewCol){
                ...
                return col;
            //return  viewCol + edu.psu.geovista.app.spreadsheet.model.SSTableModel.BASE_COL -1 ;//jin
        }
        /**
    ...
    public static int translateVVColumn(String column) {
        ...
        //return col+edu.psu.geovista.app.spreadsheet.model.SSTableModel.BASE_COL ;
    }
	...
	//column = column - baseCol +1;
        //column = column - edu.psu.geovista.app.spreadsheet.model.SSTableModel.BASE_COL + 1;
        if (column < 1)
            return null;
