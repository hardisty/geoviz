...
public class GMLWriter implements JUMPWriter {
    ...
    public static final String standard_geom = "geometry";
    public static final String standard_feature = "feature";
    public static final String standard_featureCollection = "featureCollection";
