...
import geovista.jts.geom.CoordUtil;
import geovista.jts.geom.EnvelopeUtil;
...
public class Viewport implements Java2DConverter.PointConverter {
    ...
    public Viewport(Component panel) {
        this.panel = panel;
...
//    }
    ...
    public Envelope fullExtent() {
    	Envelope env = new Envelope(0,0,panel.getWidth(),panel.getHeight());
    	return EnvelopeUtil.bufferByFraction(env, 0.03);
