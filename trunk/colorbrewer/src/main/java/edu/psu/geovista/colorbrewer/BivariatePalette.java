//******************************************************************************
// class oblivion.awt.colorbrewer.BivariatePalette
// Copyright (c) 2005 GeoVISTA Center. All rights reserved.
//******************************************************************************
// File: BivariatePalette.java
// Last modified: Thu Aug 31 10:16:28 2006 by Chris Weaver
//******************************************************************************
	...
	implements Palette2D
{
	...
	public BivariatePalette(String name, int type, int[][] colors)
	{
		this.name = name;
		this.type = type;
	...
	public static final BivariatePalette	QUA_SEQ_BELL_CURVE1 =
		new BivariatePalette("quaseqbellcurve1", QUALITATIVE_SEQUENTIAL,
				new int[][] {{0xffd5d1,0xfff2a0,0x94ffe0,0x81ffff,0xffe0ff},
	...
	public static final BivariatePalette	QUA_SEQ_BELL_CURVE2 =
		new BivariatePalette("quaseqbellcurve2", QUALITATIVE_SEQUENTIAL,
				new int[][] {{0xc9d2ff,0xffafd5,0xffcf73,0x87f1a0,0x00f3ff},
	...
	// vertex=141, divider=7500, lightness range=26~95,
	// startinghue=25, deviation a-b=0, deviationy=0
	public static final BivariatePalette	SEQ_QUA_BELL_CURVE1 =
		new BivariatePalette("seqquabellcurve1", SEQUENTIAL_QUALITATIVE,
				new int[][] {{0xffd5d1,0xff9494,0xff5360,0xda002f,0xb40008},
	...
	// vertex=164, divider=4913, lightness range=23~87,
	// startinghue=292, deviation a-b=0, deviationy=0
	public static final BivariatePalette	SEQ_QUA_BELL_CURVE2 =
		new BivariatePalette("seqquabellcurve2", SEQUENTIAL_QUALITATIVE,
				new int[][] {{0xc9d2ff,0x94a5ff,0x577bfb,0x0053de,0x0031c7},
	...
	public static final BivariatePalette	QUA_SEQ_CONE1 =
		new BivariatePalette("quaseqcone1", QUALITATIVE_SEQUENTIAL,
				new int[][] {{0xffe2ee,0xfff2bd,0xc7ffdc,0xa6ffff,0xf9f0ff},
	...
	// cone height=130, cone radius=120, lightness range=35~97,
	// startinghue=10, deviation a-b=0, deviationy=0
	public static final BivariatePalette	SEQ_QUA_CONE1 =
		new BivariatePalette("quaseqcone1", QUALITATIVE_SEQUENTIAL,
				new int[][] {{0xffe2ee,0xffa8bd,0xff7091,0xe42265,0xc40040},
	...
	public static final BivariatePalette	DIV_DIV_BELL_CURVE1 =
		new BivariatePalette("divdivbellcurve1", DIVERGING_DIVERGING,
				new int[][] {{0x008adc,0x00b3d9,0x00c4ba,0x00b27a,0x00881d},
	...
	public static final BivariatePalette	DIV_DIV_BELL_CURVE2 =
		new BivariatePalette("divdivbellcurve2", DIVERGING_DIVERGING,
				new int[][] {{0x007fff,0x00acff,0x00c4f2,0x00b6b4,0x008d61},
	...
	public static final BivariatePalette	DIV_SEQ_ELLIPSE_DOWN1 =
		new BivariatePalette("divseqellipsedown1", DIVERGING_SEQUENTIAL,
				new int[][] {{0xffb6ff,0xffefff,0xffffff,0xdbffce,0x79fe6d},
	...
	// top angle=90, shape index=80, lightness range=46~100,
	// startinghue=138, deviation a-b=0, deviationy=4
	public static final BivariatePalette	SEQ_DIV_ELLIPSE_DOWN1 =
		new BivariatePalette("seqdivellipsedown1", SEQUENTIAL_DIVERGING,
				new int[][] {{0xffb6ff,0xfb9eff,0xd085ee,0xaa6ec2,0x825693},
	...
	public static final BivariatePalette	DIV_SEQ_TRAPEZOID1 =
		new BivariatePalette("divseqtrapezoid1", DIVERGING_SEQUENTIAL,
				new int[][] {{0xffb24f,0xffcf93,0xf1f1f1,0xbefaff,0x00ffff},
	...
	// top angle=109, radius=75, lightness range=50~95,
	// startinghue=230, deviation a-b=0, deviationy=0
	public static final BivariatePalette	SEQ_DIV_TRAPEZOID1 =
		new BivariatePalette("seqdivtrapezoid1", SEQUENTIAL_DIVERGING,
				new int[][] {{0xffb24f,0xff9234,0xff7619,0xff5a00,0xdc3d00},
	...
	public static final BivariatePalette	DIV_SEQ_GRID1 =
		new BivariatePalette("divseqgrid1", DIVERGING_SEQUENTIAL,
				new int[][] {{0x00eed0,0xa1f9e7,0xffffff,0xffd4ea,0xffa2d4},
	...
	// top angle=150, saturation range=120, lightness range=35~100,
	// startinghue=0, deviation a-b=0, deviationy=0
	public static final BivariatePalette	SEQ_DIV_GRID1 =
		new BivariatePalette("seqdivgrid1", SEQUENTIAL_DIVERGING,
				new int[][] {{0x00eed0,0x00bda2,0x009178,0x006651,0x003e2d},
	...
	public static final BivariatePalette	SEQ_SEQ_GRAY_DIAMOND1 =
		new BivariatePalette("seqseqgraydiamond1", SEQUENTIAL_SEQUENTIAL,
				new int[][] {{0xe6e6e6,0xf4bccf,0xfc8eb8,0xff5aa5,0xff008f},
	...
	public static final BivariatePalette	SEQ_SEQ_GRAY_DIAMOND2 =
		new BivariatePalette("seqseqgraydiamond2", SEQUENTIAL_SEQUENTIAL,
				new int[][] {{0xfffff4,0xdbeef6,0x8ddbf8,0x00c7f9,0x00b3fa},
	...
	public static final BivariatePalette	SEQ_SEQ_NONGRAY_DIAMOND1 =
		new BivariatePalette("seqseqnongraydiamond1", SEQUENTIAL_SEQUENTIAL,
				new int[][] {{0xf9e3df,0xe9c6ec,0xd6a8f8,0xc18bff,0xa76dff},
