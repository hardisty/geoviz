...
public class DesignBoardCIECAM02 extends JPanel implements ActionListener, ChangeListener{
	protected final static Logger logger = Logger.getLogger(DesignBoardCIECAM02.class.getName());
  ...
  JPanel colorAppearancePanel = new JPanel();
  ...
  JRadioButton quaseqCustomButton = new JRadioButton("Custom");
  JPanel[] quaseqCustomSamples = new JPanel[15];
  JPanel[] quaseqCustomSamples_pink = new JPanel[15];
  JPanel[] quaseqCustomSamples_red = new JPanel[15];
  JPanel[] quaseqCustomSamples_orange = new JPanel[15];
  JPanel[] quaseqCustomSamples_brown = new JPanel[15];
  JPanel[] quaseqCustomSamples_yellow = new JPanel[15];
  JPanel[] quaseqCustomSamples_olive = new JPanel[15];
  JPanel[] quaseqCustomSamples_yellowishgreen = new JPanel[15];
  JPanel[] quaseqCustomSamples_green = new JPanel[15];
  JPanel[] quaseqCustomSamples_bluishgreen = new JPanel[15];
  JPanel[] quaseqCustomSamples_greenishblue = new JPanel[15];
  JPanel[] quaseqCustomSamples_blue = new JPanel[15];
  JPanel[] quaseqCustomSamples_purplishblue = new JPanel[15];
  JPanel[] quaseqCustomSamples_violet = new JPanel[15];
  JPanel[] quaseqCustomSamples_purple = new JPanel[15];
  JPanel[] quaseqCustomSamples_purplishred = new JPanel[15];
  JPanel quaseqCustomPanel = new JPanel();
  JCheckBox[] quaseqCustomCheckBoxes = new JCheckBox[15];
  //invisible Panels that help make the layout better
  JPanel northSpaceFiller = new JPanel();
  JPanel southSpaceFiller = new JPanel();
  JPanel westSpaceFiller = new JPanel();
  JPanel eastSpaceFiller = new JPanel();
  JPanel quaseqCustomCheckBoxesHolder = new JPanel();
  JPanel quaseqCustomCheckBoxesHolder_left = new JPanel();
  JPanel quaseqCustomCheckBoxesHolder_right = new JPanel();
  JButton quaseqCustomFireButton = new JButton();
  CIECAM02toSRGB[] cIECAM02toSRGB_hues = new CIECAM02toSRGB[15];
  CIECAM02Color[][] quaseqCustom_CIECAM02Color = new CIECAM02Color[15][15];
  ...
  public DesignBoardCIECAM02() {
    ...
    this.tabbedPane.add("P", this.colorAppearancePanel);
    ...
    this.quaseqGeometricObjectPanel.setLayout(new GridLayout(5, 1));
    ...
    this.quaseqGeometricObjectPanel.add(this.quaseqCustomButton);
    ...
    this.quaseqButtongroup.add(this.quaseqCustomButton);
    ...
    this.quaseqCustomButton.addActionListener(this);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if(e.getSource() == this.seqseqDiamondButton){
      if(this.seqseqDiamondButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.seqseqDiamond1.cIECAM02color);
    ...
    */
    ...
    if(e.getSource() == this.seqseqTiltedDiamondButton){
      if(this.seqseqTiltedDiamondButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.seqseqTiltedDiamond1.cIECAM02color);
    ...
    if(e.getSource() == this.seqseqFoldedDiamondButton){
      if(this.seqseqFoldedDiamondButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.seqseqFoldedDiamond1.cIECAM02color);
    ...
    if(e.getSource() == this.divseqWedgeButton){
      if(this.divseqWedgeButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divseqWedge1.cIECAM02color);
    ...
    if(e.getSource() == this.divseqEllipseButton){
      if(this.divseqEllipseButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divseqEllipse1.cIECAM02color);
    ...
    if(e.getSource() == this.divseqTrapezoidButton){
      if(this.divseqTrapezoidButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divseqTrapezoid1.cIECAM02color);
    ...
    if(e.getSource() == this.quaseqConeButton){
      if(this.quaseqConeButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.quaseqCone1.cIECAM02Color);
    ...
    if(e.getSource() == this.quaseqEllipsoidButton){
      ...
      if(this.quaseqEllipsoidButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.quaseqEllipsoid1.cIECAM02color);
    ...
    if(e.getSource() == this.quaseqEllipseCurveButton){
      ...
      if(this.quaseqEllipseCurveButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.quaseqEllipsecurve1.cIECAM02color);
    ...
    if(e.getSource() == this.quaseqBellshapeButton){
      ...
      if(this.quaseqBellshapeButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.quaseqBellshape1.cIECAM02color);
    ...
    if(e.getSource() == this.quaseqCustomButton){

      if(this.quaseqCustomButton.isSelected() == true){
        this.quaseqParameterPanel.removeAll();
        this.quaseqCustomCheckBoxesHolder.removeAll();
        this.horizontalClass[this.getCurrentSample()].slider1.setEnabled(false);
        this.horizontalClass[this.getCurrentSample()].spinner1.setEnabled(false);
        this.repaint();
        this.revalidate();

        this.quaseqParameterPanel.setBorder(BorderFactory.createTitledBorder("Select Custom Hues"));

        this.quaseqParameterPanel.setLayout(new BorderLayout());

        this.northSpaceFiller.setPreferredSize(new Dimension(370, 25));
        this.quaseqParameterPanel.add(this.northSpaceFiller, BorderLayout.NORTH);
        this.southSpaceFiller.setPreferredSize(new Dimension(370, 5));
        this.quaseqParameterPanel.add(this.southSpaceFiller, BorderLayout.SOUTH);
        //this.westSpaceFiller.setPreferredSize(new Dimension(5, 150));
        //this.quaseqParameterPanel.add(this.westSpaceFiller, BorderLayout.WEST);
        this.eastSpaceFiller.setPreferredSize(new Dimension(60, 150));
        this.quaseqParameterPanel.add(this.eastSpaceFiller, BorderLayout.EAST);

        this.quaseqParameterPanel.add(this.quaseqCustomPanel, BorderLayout.CENTER);

        //this.quaseqCustomPanel.setBackground(Color.WHITE);


        for(int i = 0; i < 15; i ++){
          this.quaseqCustomSamples[i] = new JPanel();
          this.quaseqCustomSamples[i].setPreferredSize(new Dimension(15, 150));
          this.quaseqCustomSamples[i].setLayout(new GridLayout(15, 1));
        }

        for(int i = 0; i < 15; i ++){
          this.quaseqCustomSamples_pink[i] = new JPanel();
          this.quaseqCustomSamples[0].add(this.quaseqCustomSamples_pink[i]);

          this.quaseqCustomSamples_red[i] = new JPanel();
          this.quaseqCustomSamples[1].add(this.quaseqCustomSamples_red[i]);

          this.quaseqCustomSamples_orange[i] = new JPanel();
          this.quaseqCustomSamples[2].add(this.quaseqCustomSamples_orange[i]);

          this.quaseqCustomSamples_brown[i] = new JPanel();
          this.quaseqCustomSamples[3].add(this.quaseqCustomSamples_brown[i]);

          this.quaseqCustomSamples_yellow[i] = new JPanel();
          this.quaseqCustomSamples[4].add(this.quaseqCustomSamples_yellow[i]);

          this.quaseqCustomSamples_olive[i] = new JPanel();
          this.quaseqCustomSamples[5].add(this.quaseqCustomSamples_olive[i]);

          this.quaseqCustomSamples_yellowishgreen[i] = new JPanel();
          this.quaseqCustomSamples[6].add(this.quaseqCustomSamples_yellowishgreen[i]);

          this.quaseqCustomSamples_green[i] = new JPanel();
          this.quaseqCustomSamples[7].add(this.quaseqCustomSamples_green[i]);

          this.quaseqCustomSamples_bluishgreen[i] = new JPanel();
          this.quaseqCustomSamples[8].add(this.quaseqCustomSamples_bluishgreen[i]);

          this.quaseqCustomSamples_greenishblue[i] = new JPanel();
          this.quaseqCustomSamples[9].add(this.quaseqCustomSamples_greenishblue[i]);

          this.quaseqCustomSamples_blue[i] = new JPanel();
          this.quaseqCustomSamples[10].add(this.quaseqCustomSamples_blue[i]);

          this.quaseqCustomSamples_purplishblue[i] = new JPanel();
          this.quaseqCustomSamples[11].add(this.quaseqCustomSamples_purplishblue[i]);

          this.quaseqCustomSamples_violet[i] = new JPanel();
          this.quaseqCustomSamples[12].add(this.quaseqCustomSamples_violet[i]);

          this.quaseqCustomSamples_purple[i] = new JPanel();
          this.quaseqCustomSamples[13].add(this.quaseqCustomSamples_purple[i]);

          this.quaseqCustomSamples_purplishred[i] = new JPanel();
          this.quaseqCustomSamples[14].add(this.quaseqCustomSamples_purplishred[i]);
        }

        //preset colors derived from quaseqBellshape model
        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 5);
          this.quaseqCustomSamples_pink[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 20);
          this.quaseqCustomSamples_red[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 40);
          this.quaseqCustomSamples_orange[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 60);
          this.quaseqCustomSamples_brown[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 90);
          this.quaseqCustomSamples_yellow[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 115);
          this.quaseqCustomSamples_olive[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 130);
          this.quaseqCustomSamples_yellowishgreen[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 164);
          this.quaseqCustomSamples_green[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 185);
          this.quaseqCustomSamples_bluishgreen[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 210);
          this.quaseqCustomSamples_greenishblue[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 238);
          this.quaseqCustomSamples_blue[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 265);
          this.quaseqCustomSamples_purplishblue[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 285);
          this.quaseqCustomSamples_violet[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 315);
          this.quaseqCustomSamples_purple[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }

        for(int i = 0; i < 15; i ++){
          cIECAM02toSRGB_hues[i] = new CIECAM02toSRGB(85 - i*3, 70, 345);
          this.quaseqCustomSamples_purplishred[i].setBackground(new Color((int)cIECAM02toSRGB_hues[i].R255, (int)cIECAM02toSRGB_hues[i].G255, (int)cIECAM02toSRGB_hues[i].B255));
        }


        this.quaseqCustomPanel.setLayout(new FlowLayout());
        for(int i = 0; i < 15; i ++){
          this.quaseqCustomPanel.add(quaseqCustomSamples[i]);
        }

        this.northSpaceFiller.setLayout(new BorderLayout());
        this.northSpaceFiller.add(this.quaseqCustomCheckBoxesHolder_left, BorderLayout.WEST);
        this.quaseqCustomCheckBoxesHolder_left.setPreferredSize(new Dimension(4, 25));
        this.northSpaceFiller.add(this.quaseqCustomCheckBoxesHolder_right, BorderLayout.EAST);
        this.quaseqCustomCheckBoxesHolder_right.setPreferredSize(new Dimension(43, 25));
        this.northSpaceFiller.add(this.quaseqCustomCheckBoxesHolder, BorderLayout.CENTER);
        this.quaseqCustomCheckBoxesHolder.setPreferredSize(new Dimension(330, 25));

        for(int i = 0; i < 15; i ++){
          this.quaseqCustomCheckBoxesHolder.setLayout(new GridLayout(1, 15));
          this.quaseqCustomCheckBoxes[i] = new JCheckBox();
          this.quaseqCustomCheckBoxesHolder.add(this.quaseqCustomCheckBoxes[i]);
        }

        this.eastSpaceFiller.add(this.quaseqCustomFireButton);
        this.quaseqCustomFireButton.setPreferredSize(new Dimension(55, 30));
        this.quaseqCustomFireButton.setText("Go!");
        this.quaseqCustomFireButton.addActionListener(this);

      }

    }

    if(e.getSource() == this.quaseqCustomFireButton){
      ...
      for(int i = 0; i < 15; i ++){
        if(this.quaseqCustomCheckBoxes[i].isSelected()){
          n = n + 1;
        }
      }

      this.horizontalClass[this.getCurrentSample()].slider1.setValue(n);

      this.createQuaseqCustom();

      logger.finest("n = " + n);

      logger.finest("Horizontal classes = " + Integer.valueOf(String.valueOf(this.horizontalClass[this.getCurrentSample()].spinner1.getValue())).intValue());
      logger.finest("Vertical classes = " + Integer.valueOf(String.valueOf(this.verticalClass[this.getCurrentSample()].spinner1.getValue())).intValue());
    ...
    if(e.getSource() == this.divdivConeButton){
      if(this.divdivConeButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divdivCone1.cIECAM02color);
    ...
    if(e.getSource() == this.divdivEllipsoidButton){
      ...
      if(this.divdivEllipsoidButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divdivEllipsoid1.cIECAM02color);
    ...
    if(e.getSource() == this.divdivEllipseCurveButton){
      ...
      if(this.divdivEllipseCurveButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divdivEllipsecurve1.cIECAM02color);
    ...
    if(e.getSource() == this.divdivBellshapeButton){
      ...
      if(this.divdivBellshapeButton.isSelected() == true){
        ...
        this.createPatches(this.verticalClass[this.getCurrentSample()].slider1.getValue(), this.horizontalClass[this.getCurrentSample()].slider1.getValue(), this.divdivBellshape1.cIECAM02color);
    ...
    for(int i = 0; i < 3; i ++){
      if(e.getSource() == this.checkbox[i]){
        if(this.checkbox[i].isSelected()){
        if(this.tabbedPane.getSelectedIndex() == 2 && this.quaseqCustomButton.isSelected()){
          this.horizontalClass[i].slider1.setEnabled(false);
          this.horizontalClass[i].spinner1.setEnabled(false);
        }
        }
    ...
    for(int i = 0; i < 3; i ++){
      if(e.getSource() == this.horizontalClass[i].spinner1 || e.getSource() == this.verticalClass[i].spinner1){
        ...
        if(this.getCurrentGeometricModel() == "SeqseqDiamond"){
          ...
          this.createPatches(m, n, this.seqseqDiamond1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "SeqseqTiltedDiamond"){
          ...
          this.createPatches(m, n, this.seqseqTiltedDiamond1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "SeqseqFoldedDiamond"){
          ...
          this.createPatches(m, n, this.seqseqFoldedDiamond1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivseqWedge"){
          ...
          this.createPatches(m, n, this.divseqWedge1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivseqEllipse"){
          ...
          this.createPatches(m, n, this.divseqEllipse1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivseqTrapezoid"){
          ...
          this.createPatches(m, n, this.divseqTrapezoid1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "QuaseqCone"){
          ...
          this.createPatches(m, n, this.quaseqCone1.cIECAM02Color);
        }
        if(this.getCurrentGeometricModel() == "QuaseqEllipsoid"){
          ...
          this.createPatches(m, n, this.quaseqEllipsoid1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "QuaseqEllipsecurve"){
          ...
          this.createPatches(m, n, this.quaseqEllipsecurve1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "QuaseqBellshape"){
          ...
          this.createPatches(m, n, this.quaseqBellshape1.cIECAM02color);
        }

        if(this.getCurrentGeometricModel() == "QuaseqCustom"){
          this.createQuaseqCustom();
        }
        ...
        if(this.getCurrentGeometricModel() == "DivdivCone"){
          ...
          this.createPatches(m, n, this.divdivCone1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivdivEllipsoid"){
          ...
          this.createPatches(m, n, this.divdivEllipsoid1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivdivEllipsecurve"){
          ...
          this.createPatches(m, n, this.divdivEllipsecurve1.cIECAM02color);
        }
        if(this.getCurrentGeometricModel() == "DivdivBellshape"){
          ...
          this.createPatches(m, n, this.divdivBellshape1.cIECAM02color);
        }
      }
    }
  ...
  private void createQuaseqCustom(){
    ...
    int vclass = this.verticalClass[this.getCurrentSample()].slider1.getValue();
    int hclass = n;

    for(int i = 0; i < 15; i ++){
      for(int j = 0; j < 15; j ++){
        CIECAM02Color color =  new CIECAM02Color(0, 0, 0);

        this.quaseqCustom_CIECAM02Color[i][j] = color;
      }
    }

    CIECAM02Color[][] condensedColorArray = new CIECAM02Color[vclass][hclass];

    for(int i = 0; i < vclass; i ++){
      for(int j = 0; j < hclass; j ++){
        condensedColorArray[i][j] =  new CIECAM02Color(0, 0, 0);
      }
    }

    int count = 0;

    if(this.quaseqCustomCheckBoxes[0].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 5;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[1].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 20;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[2].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 40;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[3].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 60;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[4].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 90;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[5].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 115;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[6].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 130;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[7].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 164;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[8].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 185;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[9].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 210;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[10].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 238;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[11].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 265;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[12].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 285;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[13].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 315;
      }
      count = count + 1;
    }

    if(this.quaseqCustomCheckBoxes[14].isSelected() == true){
      for(int i = 0; i < vclass; i ++){
        condensedColorArray[i][count].J = 95.0 - (95.0 - 25.0)*i/(vclass - 1);
        condensedColorArray[i][count].C = 50.0 + (75.0 - 50.0)*i/(vclass - 1);
        condensedColorArray[i][count].h = 345;
      }
      count = count + 1;
    }

    this.createPatches(vclass, hclass, condensedColorArray);

  }

  private void createPatches(int vclass, int hclass, CIECAM02Color cIECAM02color[][]){

    logger.finest("Patches created!");
    ...
    for(int i = 0; i < vclass; i ++){
      for(int j = 0; j < hclass; j ++){
        ...
        CIECAM02toSRGB cIECAM02toSRGB1 = new CIECAM02toSRGB(cIECAM02color[i][j].J, cIECAM02color[i][j].C, cIECAM02color[i][j].h);
        JPanel p = new JPanel();
        ...
        this.colorarray[i][j][0][this.getCurrentSample()] = (int)cIECAM02toSRGB1.R255;
        this.colorarray[i][j][1][this.getCurrentSample()] = (int)cIECAM02toSRGB1.G255;
        this.colorarray[i][j][2][this.getCurrentSample()] = (int)cIECAM02toSRGB1.B255;
  ...
  private String getCurrentGeometricModel(){
    ...
    if(this.tabbedPane.getSelectedIndex() == 2){
      ...
      if(this.quaseqCustomButton.isSelected()){
        currentGeometricModel = "QuaseqCustom";
      }
    }
