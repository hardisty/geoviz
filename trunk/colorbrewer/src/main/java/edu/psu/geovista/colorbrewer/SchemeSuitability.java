...
/**
 ...
 Java source file for the class SchemeSuitability
...
public class SchemeSuitability {
  ...
  /*////////////////////////////////////////////////////////////////////////////
  This is the suitability information of each of the schemes:
  3 stands for the fact that this color scheme is good for this purpose;
  2 stands for the fact that it is doubtful whether this scheme is good;
  1 stands for the fact that this scheme is not suitable for this purpose.
  ...
  public int[] getSuitability(String schemename, int numberofClasses){
    //create an array to store the suitability information, length is 6 because there are six suitability concerns
    int[] suitability = new int[6];
    //if numberofClasses is within 9, get the correct scheme according to the schemename. numberofClasses - 1 because the array starts from 2
    if(schemename == "YlGn" || schemename == "YlGnBu" || schemename == "GnBu" || schemename == "BuGn" || schemename == "PuBuGn" || schemename == "PuBu"|| schemename == "BuPu"|| schemename == "RdPu"|| schemename == "PuRd"|| schemename == "OrRd"|| schemename == "YlOrRd"|| schemename == "YlOrBr"|| schemename == "Purples"|| schemename == "Blues"|| schemename == "Greens"|| schemename == "Oranges"|| schemename == "Reds"|| schemename == "Grays"){
    ...
    if(schemename == "PuOr" || schemename == "BrBG"|| schemename == "PRGn"|| schemename == "PiYG"|| schemename == "RdBu"|| schemename == "RdGy"|| schemename == "RdYlBu"|| schemename == "Spectral"|| schemename == "RdYlGn"){
