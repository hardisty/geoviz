...
public class BiPlotMatrixBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			...
			PropertyDescriptor _bivarColorClasser = new PropertyDescriptor(
					"bivarColorClasser", beanClass, "getBivarColorClasser",
			...
			PropertyDescriptor[] pds = new PropertyDescriptor[] { _background,
					_selectionColor, _selOriginalColorMode, _bivarColorClasser,
					_elementClassName1, _elementClassName2, _maxNumArrays,
					_plottedBegin };
			return pds;
