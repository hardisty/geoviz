...
package geovista.image_blur.image;

import java.awt.image.*;
import java.util.logging.Logger;

import geovista.image_blur.math.*;
...
public class LensBlurFilter extends AbstractBufferedImageOp {
	...
	private int sides = 5;
	protected final static Logger logger = Logger.getLogger(LensBlurFilter.class.getName());
	/**
...
logger.finest("Tile: "+tileX+" "+tileY+" "+tileWidth+" "+tileHeight);
