/* The following code was generated by JFlex 1.3.5 on 2/6/02 8:40 AM */
 ...
 * psu.edu.geovista.io.csv.CSVParser instead.	That class, has a cleaner API, and methods
 ...
 *	   logger.finest("" + shredder.getLineNumber() + " " + t);
 * }
 * </pre>
 *
 */
 ...
 * 1.3.5 on 2/6/02 8:40 AM from the specification file
 * <tt>file:/home/steveo/personal/projects/java/com/Ostermiller/util/CSVLexer.lex</tt>
 */
public class CSVLexer {
	protected final static Logger logger = Logger.getLogger(CSVLexer.class
			.getName());
	 ...
	 */
	final private static String yycmap_packed = "\11\0\1\1\1\3\1\0\1\1\1\2\22\0\1\1\1\0\1\4"
	 ...
	 */
	final private static int yy_rowMap[] = { 0, 7, 14, 21, 28, 35, 42, 49, 56,
			49, 63, 70, 77, 49, 84, 49, 91, 98, 49, 105, 28, 35, 49, 112, 63,
			49, 119, 56, 84 };

	/**
	 * The packed transition table of the DFA (part 0)
	 */
	final private static String yy_packed0 = "\1\5\1\6\1\7\1\10\1\11\1\12\1\5\1\13"
	 ...
	 */
	private final static byte YY_ATTRIBUTE[] = { 0, 1, 1, 1, 1, 1, 1, 9, 0, 9,
			1, 1, 1, 9, 0, 9, 1, 1, 9, 1, 0, 0, 9, 0, 0, 9, 0, 1, 1 };

	/** the input device */
	private transient java.io.Reader yy_reader;

	/** the current state of the DFA */
	private transient int yy_state;

	/** the current lexical state */
	private transient int yy_lexical_state = YYINITIAL;

	/**
	 * this buffer contains the current text to be matched and is the source of
	 * the yytext() string
	 */
	private transient char yy_buffer[] = new char[YY_BUFFERSIZE];

	/** the textposition at the last accepting state */
	private transient int yy_markedPos;

	/** the textposition at the last state to be included in yytext */
	private transient int yy_pushbackPos;

	/** the current text position in the buffer */
	private transient int yy_currentPos;

	/** startRead marks the beginning of the yytext() string in the buffer */
	private transient int yy_startRead;

	/**
	 * endRead marks the last character in the buffer, that has been read from
	 * input
	 */
	private transient int yy_endRead;

	/** yy_atEOF == true <=> the scanner is at the EOF */
	private transient boolean yy_atEOF;
