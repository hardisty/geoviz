 ...
 *
 * Description:
 *              The bar for editing a cell's edu.psu.geovista.app.spreadsheet.formula
 * Date: Mar 25, 2003
 * Time: 10:39:53 AM
 * @author Jin Chen
 */
...
public class FormulaEditor extends JPanel{
  ...
  JTextField formulaF;//edu.psu.geovista.app.spreadsheet.formula address for editing
  SSTable tb;
  public FormulaEditor(SSTable _tb) {
      ...
      formulaF.addKeyListener(new KeyListener(){
            ...
            public void keyReleased(KeyEvent e){
                //synchronize the value in edu.psu.geovista.app.spreadsheet.formula editor and cell editor
