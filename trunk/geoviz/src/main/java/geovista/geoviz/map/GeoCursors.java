 ...
 * 
 * GeoCursors lazily creates and then keeps instances of cursors to be called
 * when needed.
 * 
 */
public class GeoCursors extends Component {
	...
	private static final URL urlPan = GeoCursors.class
			.getResource("resources/pan.gif");
	// private static final URL urlZoomIn =
	// GeoCursors.class.getResource("resources/zoomIn.gif");
	// private static final URL urlZoomOut =
	// GeoCursors.class.getResource("resources/zoomOut.gif");
	private static final URL urlGrab = GeoCursors.class
			.getResource("resources/grab.gif");
	private static final URL urlArrowZoomIn = GeoCursors.class
			.getResource("resources/arrowZoomIn.gif");
	private static final URL urlArrowZoomOut = GeoCursors.class
			.getResource("resources/arrowZoomOut.gif");
	private static final URL urlArrowSelect = GeoCursors.class
			.getResource("resources/arrowSelect.gif");
	private static final URL urlArrowPan = GeoCursors.class
			.getResource("resources/arrowPan.gif");
	...
	public Cursor getCursor(int cursor) {
		...
		if (cursors[cursor] == null) {
			Point pt = null;
			if (cursor == GeoCursors.CURSOR_PAN
					|| cursor == GeoCursors.CURSOR_GRAB) {
			...
			cursors[cursor] = getToolkit().createCustomCursor(im, pt, "custom");
		}
