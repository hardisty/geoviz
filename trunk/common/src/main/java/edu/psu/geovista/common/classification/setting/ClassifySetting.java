package edu.psu.geovista.common.classification.setting;
...
public interface ClassifySetting {
    public static final int TYPE_VARIABLE=1; //change variable based on which classification is make
    public static final int TYPE_BOUNDARY=2; //change boundary of some categories
    public static final int TYPE_NUM_OF_CATEGORY=3;//change number of categories
    public static final int TYPE_METHOD=4;//change number of categories
    public static final int TYPE_COMBINED=9;//any combination of VARIABLE,BOUNDARY,NUM_OF_CATEGORY
    ...
    /*public static final int DIMENSION_1D=10;
    public static final int DIMENSION_2D=20;
    public static final int DIMENSION_ND=30;*/
    /**
