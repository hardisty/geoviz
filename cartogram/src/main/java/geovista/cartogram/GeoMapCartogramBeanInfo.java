...
public class GeoMapCartogramBeanInfo extends SimpleBeanInfo {
	static Class beanClass = GeoMapCartogram.class;
	static String iconColor16x16Filename = "resources/cartogram16.gif";
	static String iconColor32x32Filename = "resources/cartogram32.gif";
