...
public class ColorItemList  extends JList{
    ...
    class GreyItemRender extends DefaultListCellRenderer{
        ...
        public void colorItem(int index,boolean grey) {
            if(grey)
                this.indexOfGreyItem.add(new Integer(index));
            else
                this.indexOfGreyItem.remove(new Integer(index));
        }
        public boolean isItemColored(int index ) {
        ...
        public Component getListCellRendererComponent(
               ...
               boolean cellHasFocus)
           {
               ...
               //Componentsuper.getListCellRendererComponent(list,value,index,isSelected,cellHasFocus);
