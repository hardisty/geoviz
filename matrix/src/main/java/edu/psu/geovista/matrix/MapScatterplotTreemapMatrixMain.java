/* -------------------------------------------------------------------
 ...
 MapScatterplotTreemapMatrix
 Copyright (c), 2003, Frank Hardisty
 All Rights Reserved.
 Original Author: Frank Hardisty
 $Author: hardisty $
 $Id: MapScatterplotTreemapMatrixMain.java,v 1.1 2005/04/19 14:07:03 hardisty Exp $
...
/**
 * Special edu.psu.geovista.matrix.treemap.tm that knows how to handle quantitative data. Responds to and
...
public class MapScatterplotTreemapMatrixMain {
	...
	public static void main(String[] args) {
		JFrame app = new JFrame("MapScatterplotTreemapMatrixMain");
		MapScatterplotTreemapMatrix tm = new MapScatterplotTreemapMatrix();
