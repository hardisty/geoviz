/* -------------------------------------------------------------------
 ...
 Java source file for the class ColorRamp
 Copyright (c), 2002, GeoVISTA Center
 All Rights Reserved.
 Original Author: Frank Hardisty
 $Author: hardisty $
 $Id: ColorRamp.java,v 1.4 2005/02/12 20:27:27 hardisty Exp $
 $Date: 2005/02/12 20:27:27 $
              ...
              if (anchored[k]) {
                ...
                if (numSwatches  > 0) {
                  ...
                  for (int l = currLowSwatch+1; l < currHighSwatch; l++){
                    float prop;
                    prop = (float)currSwat/((float)numSwatches+1);
                    currSwat++;
