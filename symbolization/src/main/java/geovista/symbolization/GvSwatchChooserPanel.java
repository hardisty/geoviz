/* -------------------------------------------------------------------
 ...
 Java source file for the class GvSwatchChooserPanel
 Copyright (c), 2002, GeoVISTA Center
 All Rights Reserved.
 Original Author: Frank Hardisty
 $Author: hardisty $
 $Id: GvSwatchChooserPanel.java,v 1.2 2003/04/25 18:08:50 hardisty Exp $
...
public class GvSwatchChooserPanel extends JPanel {
  ...
  public GvSwatchChooserPanel() {
    initValues();
    initColors();
    this.setLayout(new GridLayout(numSwatches.height,numSwatches.width,gap.width,gap.height));
