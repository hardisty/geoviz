...
/**
 * Specifies the format of a CSV file and parses input. <h4>Using predefined
 * formats</h4>
 * <p>
 ...
 * </pre>
 * <p>
 * The {@link CSVRecord} provides static methods to parse other input types, for
 * example:
 * </p>
 * 
 * <pre>
 ...
 * address values in a {@link CSVRecord}, and assumes that your CSV source does
 * not contain a first record that also defines column names. If it does, then
 * you are overriding this metadata with your names and you should skip the
 * first record by calling {@link #withSkipHeaderRecord(boolean)} with
 * {@code true}.
 * </p>
 * <h4>Parsing</h4>
 * <p>
 ...
 * safely reference columns, by using {@link #withHeader(String...)} with no
 * arguments:
 * </p>
 * 
 * <pre>
 ...
 * names. Then, call one of the {@link CSVRecord} get method that takes a String
...
public class CSVFormat implements Serializable {
	...
	public static final CSVFormat DEFAULT = new CSVFormat(COMMA,
			DOUBLE_QUOTE_CHAR, null, null, null, false, true, CRLF, null, null,
			false);

	/**
	 * Comma separated format as defined by <a
	 * href="http://tools.ietf.org/html/rfc4180">RFC 4180</a>. <h3>RFC 4180:</h3>
	 * <ul>
	 * <li>withDelimiter(',')</li>
	 * <li>withQuoteChar('"')</li>
	 * <li>withRecordSeparator(CRLF)</li>
	 ...
	 * actual value delimiter used by Excel is locale dependent, it might be
	 * necessary to customize this format to accommodate to your regional
	 * settings.
	 * <p/>
	...
	public static final CSVFormat TDF = DEFAULT.withDelimiter(TAB)
			.withIgnoreSurroundingSpaces(true);

	/**
	 * Default MySQL format used by the <tt>SELECT INTO OUTFILE</tt> and
	 * <tt>LOAD DATA INFILE</tt> operations. This is a tab-delimited format with
	 * a LF character as the line separator. Values are not quoted and special
	...
	public static final CSVFormat MYSQL = DEFAULT.withDelimiter(TAB)
			.withEscape(BACKSLASH).withIgnoreEmptyLines(false)
			.withQuoteChar(null).withRecordSeparator(LF);
	 ...
	 *            the quote policy
	 * @param commentStart
	 *            the Character used for comment identification, may be
	 *            {@code null} to disable
	 * @param escape
	 *            the Character used to escape special characters in values, may
	 *            be {@code null} to disable
	 ...
	 *         <tt>false</tt> if they are turned into empty records.
	 */
	 ...
	 * 
	 * @return <tt>true</tt> if spaces around values are ignored, <tt>false</tt>
	 ...
	 * {@code nullString} to {@code null} when reading records.</li>
	 * <li>
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((quoteChar == null) ? 0 : quoteChar.hashCode());
		result = prime * result
				+ ((commentStart == null) ? 0 : commentStart.hashCode());
		result = prime * result + ((escape == null) ? 0 : escape.hashCode());
		result = prime * result + (ignoreSurroundingSpaces ? 1231 : 1237);
		result = prime * result + (ignoreEmptyLines ? 1231 : 1237);
		result = prime * result
				+ ((recordSeparator == null) ? 0 : recordSeparator.hashCode());
	 ...
	 * 
	 * Note that the comment start character is only recognized at the start of
	 * a line.
	 * 
	 * @param commentStart
	 *            the comment start marker
	 * @return A new CSVFormat that is equal to this one but with the specified
	 *         character as the comment start marker
	 * @throws IllegalArgumentException
	 ...
	 * 
	 * @param ignoreEmptyLines
	 *            the empty line skipping behavior, <tt>true</tt> to ignore the
	 *            empty lines between the records, <tt>false</tt> to translate
	 ...
	 * 
	 * @param ignoreSurroundingSpaces
	 *            the trimming behavior, <tt>true</tt> to remove the surrounding
	 *            spaces, <tt>false</tt> to leave the spaces as is.
	 * @return A new CSVFormat that is equal to this but with the specified
	 *         trimming behavior.
	 */
	 ...
	 * 
	 * @return A new CSVFormat that is equal to this but with the specified null
	 *         conversion string.
	 */
	 ...
	 * 
	 * @return A new CSVFormat that is equal to this but with the the specified
	...
	public static void main(String[] args) {
		try {
			Reader in = new FileReader(
					"C:/Users/Frank/Dropbox/STempo (2)/john_files/cleaned_reduced_gdelt_egypt.txt");

			Iterable<CSVRecord> parser = CSVFormat.DEFAULT.withDelimiter(
					"\t".charAt(0)).parse(in);
			int count = 0;
			ArrayList<String> eDays = new ArrayList<String>();
			...
			String[] dayArr = eDays.toArray(new String[eDays.size()]);

			eDays = null;

			String[] typeArr = type.toArray(new String[type.size()]);
