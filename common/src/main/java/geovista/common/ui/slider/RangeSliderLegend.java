 ...
 *
 * Java source file for the class RangeSliderLegend
 *
 ...
 * $Author: jmacgill $
 *
 * $Id: RangeSliderLegend.java,v 1.1.1.1 2003/02/28 14:54:07 jmacgill Exp $
 *
...
public class RangeSliderLegend extends JPanel
		...
		protected final static Logger logger = Logger.getLogger(RangeSliderLegend.class.getName());
 ...
 /**
		...
		protected void addTabs (RangeSlider[] sliderPanes) {
				...
				for (int i = 0; i < numberOfSliderPanes; i++) {
						logger.finest("RangeSliderLegend.ctor(), sliderPanes[" +
										i + "] = " + sliderPanes[i]);
	 ...
	 public String getUnits () {
		...
		/**
		 * Returns the color of the panel containing the labels of the thumb locations
		 * @return
		 */
		...
		/*
		 public void addAttSlider (String attname, double minvalue, double maxvalue, double precision)
		 Once I have the metadata, I'll call this method several times (depends on how many attributes I have).
		 Inside this method, you just create a new slider, add it to the tab pane,
		 show the attname as the tab title, customize the range of the slider with minvalue and maxvalue.
		 At this point you can just ignore the precision (I'll tell you how to use it when we meet)
		 */
		...
		public static void main (String[] args) {
				...
				/*	RangeSlider slider1 = testRangeSliderLegend.addRangeSlider("TMAX",			// attributeName
				 0.0,				 // min
				 100.0,			 // max
				 1.0);				// precision
				 ...
				 slider1.setTabTitle("Temp MAX");
				 slider1.setMajorTickSpacing(5);
				 slider1.setMinorTickSpacing(1);
				 */
				/*
				 RangeSlider slider2 = testRangeSliderLegend.addRangeSlider("TMIN",			 // name
				 -23.0,			 // min
				 77.0,				// max
				 1.0);				// precision
				 ...
				 slider2.setTabTitle("Temp MIN");
				 slider2.setMajorTickSpacing(5);
				 slider2.setMinorTickSpacing(1);
				 RangeSlider slider3 = testRangeSliderLegend.addRangeSlider("PRECIP",	 // attributeName
				 0.0,			 // min
				 5.98,			// max
				 0.01);		 // precision
				 slider3.setTitle("Precipitation Range");
				 slider3.setUnits("inches");
				 slider3.setToolTipText("Set Precipitation Min and Max");
				 slider3.setTabTitle("PRECIP");
