   ...
   /* public Object getID() {
    ...
    public Integer getViewID() {
     ...
     /*public HashSet getMemberIds() {
         return (HashSet) super.getMemberIds() ;
     }
*/
   /* public void setID(Integer ID) {
    ...
    public void tryToSetMaxMin(float value) {
        if(Float.isNaN(this.min)){//must initialize. Otherwise if all value>0, the min will be 0, which is WRONG
            this.max =value;
            this.min =value;
            return;
        }
     ...
     * Comparison is based on min value
     *
     * @param o
     * @return
     */
