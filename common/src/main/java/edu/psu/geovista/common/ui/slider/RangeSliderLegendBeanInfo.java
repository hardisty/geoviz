...
*
* Java source file for the class RangeSliderLegendBeanInfo
*
...
* $Author: jmacgill $
*
* $Id: RangeSliderLegendBeanInfo.java,v 1.1.1.1 2003/02/28 14:54:07 jmacgill Exp $
*
...
/*====================================================================
 ...
 public class RangeSliderLegendBeanInfo extends SimpleBeanInfo {
		...
		public PropertyDescriptor[] getPropertyDescriptors () {
				try {
						PropertyDescriptor createSlider = new PropertyDescriptor("createSlider",
										beanClass);
						PropertyDescriptor maximum = new PropertyDescriptor("maximum",
										beanClass);
						PropertyDescriptor minimum = new PropertyDescriptor("minimum",
										beanClass);
						PropertyDescriptor minorTickSpacing = new PropertyDescriptor("minorTickSpacing",
										beanClass);
						PropertyDescriptor majorTickSpacing = new PropertyDescriptor("majorTickSpacing",
										beanClass);
						PropertyDescriptor units = new PropertyDescriptor("units", beanClass);
						...
						PropertyDescriptor background = new PropertyDescriptor("background",
										beanClass);
						PropertyDescriptor labelPanelColor = new PropertyDescriptor("labelPanelColor",
										beanClass);
						PropertyDescriptor sliderColor = new PropertyDescriptor("sliderColor",
										beanClass);
						...
						PropertyDescriptor[] rv =	{
							 createSlider, minorTickSpacing, majorTickSpacing, maximum,
												minimum, units, tabTitle, title, background, labelPanelColor,
												sliderColor, fontColor
						};
						return	rv;
		 ...
		 * </PRE>
		 *
		 * @param iconKind an ID (ICON_COLOR_16x16 or ICON_COLOR_32x32)
